...
years = list(range(1985, 1994)) + list(range(1995, 2016)) # Leaves out 1994; no fires in 1994
years = map(str, years)
...
for yr in years:
    ...
    for bnd in brn_bnds:
        arcpy.Buffer_analysis(in_features=bnd, out_feature_class=bnd[0:40]+'burn_bndy_buff1km.shp', buffer_distance_or_field="1000 Meters", dissolve_option="ALL")
    #***Problem child is u'nv4197111497319870920_19860731_19880720_burn_bndy.shp'. Might need to go a different route.***#
